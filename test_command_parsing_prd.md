...
Require a single JSON object output only (no extra text), using OpenAI-style `tool_calls` array plus an optional error object.
...
```json
{
  "message": "short error message for user",
  "tool_calls": [],
