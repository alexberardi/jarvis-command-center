...
class TestStandardCommandInferenceSystemPromptProviderPreprocessing:
    """Test the StandardCommandInferenceSystemPromptProvider with preprocessing functionality"""
