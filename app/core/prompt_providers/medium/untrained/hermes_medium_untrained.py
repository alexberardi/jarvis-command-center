...
Built-in (vendored from the jarvis-pp-hermes Pantry package) so the model ships
in the command-center image and is covered by the GPU e2e voice-routing
benchmark (install-e2e/gpu). Keep in sync with jarvis-pp-hermes.
...
class HermesMediumUntrained(IJarvisPromptProvider):
    ...
    def build_system_prompt(
        ...
        # Shared context header (room, speaker, memories)
