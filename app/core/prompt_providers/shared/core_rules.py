...
NOT_FOR_ME_INSTRUCTION: str = (
    ...
    "If you cannot point to one of (a), (b), or (c), emit <not_for_me/>. "
    "Absence of a positive signal is itself the silence trigger; do not "
    "invent a request to fit ambient speech.\n\n"
    ...
    "Without (a), (b), or (c), emit <not_for_me/>; do not interpret "
    "ambiguous fragments as commands just because no acoustic hint "
    "fired."
)
