...
NOT_FOR_ME_INSTRUCTION: str = (
    ...
    "This rule means speech spoken TO that person. Speech ABOUT a person "
    "or pet by name — \"who is Leo?\", \"where is mom?\", \"what does "
    "Sarah like?\" — is the opposite: a question directed at YOU. Answer "
    "it from the User Profile or the recall tool.\n"
