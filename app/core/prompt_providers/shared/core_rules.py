...
NOT_FOR_ME_INSTRUCTION: str = (
    ...
    "at this\", \"Dad I need...\". Not Jarvis, not you.\n"
    ...
    "- No hint, or hint says the room was quiet before wake → ANSWER. "
    "Vague phrasing, unusual word choice, a short \"thanks\" or "
    "\"never mind\" all count as addressed to you. <not_for_me/> is "
    "for clear ambient capture, not for \"the request is hard to "
    "parse.\" Silencing a real request is worse than answering an "
    "overheard one.\n"
