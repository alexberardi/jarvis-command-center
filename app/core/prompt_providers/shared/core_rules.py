...
NOT_FOR_ME_INSTRUCTION: str = (
    ...
    "Borderline cases — answer. Vague phrasing, unusual word choice, a "
    "short \"thanks\" or \"never mind\" all count as addressed to you. "
    "<not_for_me/> is for clear ambient capture, not for \"the request "
    "is hard to parse.\" Silencing a real request is worse than "
    "answering an overheard one."
)
